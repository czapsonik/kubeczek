...
export const Route = createFileRoute("/o-nas")({
  head: () => ({
    meta: [
      { title: "O nas — Kubeczek Gołkowice (PHU Kubeczek)" },
      { name: "description", content: "Kubeczek Gołkowice — PHU Kubeczek. Lokalne centrum wyposażenia wnętrz z wieloletnim doświadczeniem w sprzedaży i montażu drzwi, paneli i bram." },
      { property: "og:title", content: "O nas — Kubeczek Gołkowice" },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-3xl px-6 py-24">
        ...
        <div className="prose prose-neutral mt-10 max-w-none text-base leading-relaxed text-muted-foreground">
          ...
          <p className="mt-4">
            Działamy w sieci Majster Plus, która od lat kojarzona jest z solidnością, wysoką jakością i sprawdzonymi producentami. W naszym salonie znajdziesz produkty takich marek jak Pol-Skone, Swiss Krono, Classen czy Querra — wszystko prezentowane na żywo na bogatej ekspozycji.
          </p>
          <p className="mt-4">
